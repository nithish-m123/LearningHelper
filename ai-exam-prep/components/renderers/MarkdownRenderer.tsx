...
export default function MarkdownRenderer({ content }: { content: string }) {
  return (
    <div className="prose prose-sm prose-invert max-w-[65ch] mx-auto prose-p:my-2 prose-headings:mt-4 prose-headings:mb-2 prose-li:my-1 prose-p:leading-normal">
      <ReactMarkdown
